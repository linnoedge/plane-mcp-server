...
| DECIMAL | =, !=, >, >=, <, <=, BETWEEN...AND..., IS NULL, IS NOT NULL | bare number |
| DATETIME | =, !=, >, >=, <, <=, BETWEEN...AND..., IS NULL, IS NOT NULL | quoted date or date fn |
| BOOLEAN | =, IS NULL, IS NOT NULL | bare true / false |
