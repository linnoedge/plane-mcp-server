...
from plane.models.work_items import CreateWorkItemLink, PaginatedWorkItemLinkResponse, UpdateWorkItemLink, WorkItemLink

from plane_mcp.client import get_plane_client_context


def register_work_item_link_tools(mcp: FastMCP) -> None:
    """Register work item link tools with the MCP server."""

    @mcp.tool()
    def list_work_item_links(
        project_id: str, work_item_id: str, params: dict[str, Any] | None = None
    ) -> list[WorkItemLink]:
    ...
    @mcp.tool()
    def retrieve_work_item_link(project_id: str, work_item_id: str, link_id: str) -> WorkItemLink:
    ...
    @mcp.tool()
    def create_work_item_link(project_id: str, work_item_id: str, url: str) -> WorkItemLink:
    ...
    @mcp.tool()
    def update_work_item_link(project_id: str, work_item_id: str, link_id: str, url: str | None = None) -> WorkItemLink:
